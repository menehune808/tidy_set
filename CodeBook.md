...
```
  ...
  ...
```
When processing is complete, wrorking directory is moved one level up and data is written to a file with the format:
descriptive name + hyphen + timestamp + file type. This CodeBook is also updated with details of this analysis.
